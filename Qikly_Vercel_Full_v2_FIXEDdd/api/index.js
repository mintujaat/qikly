...
const shopDefaultSettings = {
  siteName: "Qikly",
  tagline: "Har shopping, ek jagah.",
  announcement: "Diwali Dhamaka Sale • Extra discounts • Free shipping on eligible orders",
  heroTitle: "Diwali Dhamaka Sale",
  heroText: "Festive deals, trending products and fast checkout — sab kuch Qikly par.",
  heroImage: "https://images.unsplash.com/photo-1604917877934-07d8d248d396?auto=format&fit=crop&w=1800&q=85",
  logoText: "Qikly",
  logoMark: "Q",
  shippingFee: 49,
  ...
  banners: [
    {title:"Festive Fashion",text:"New looks starting ₹499",imageUrl:"https://images.unsplash.com/photo-1583391733956-6c78276477e2?auto=format&fit=crop&w=1200&q=85",link:"#category=fashion"},
    {title:"Home & Decor",text:"Make your home festive",imageUrl:"https://images.unsplash.com/photo-1603006905003-be475563bc59?auto=format&fit=crop&w=1200&q=85",link:"#category=home"},
    {title:"Tech Fest",text:"Smart gadgets, sharp prices",imageUrl:"https://images.unsplash.com/photo-1468495244123-6c6c332eeece?auto=format&fit=crop&w=1200&q=85",link:"#category=electronics"}
  ],
...
const shopDefaultCategories = [
  {id:"electronics",title:"Electronics",slug:"electronics",icon:"📱",imageUrl:"https://images.unsplash.com/photo-1498049794561-7780e7231661?auto=format&fit=crop&w=900&q=80",sortOrder:1,active:true},
  {id:"fashion",title:"Fashion",slug:"fashion",icon:"👗",imageUrl:"https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=900&q=80",sortOrder:2,active:true},
  {id:"home",title:"Home & Living",slug:"home",icon:"🏠",imageUrl:"https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=900&q=80",sortOrder:3,active:true},
  {id:"beauty",title:"Beauty",slug:"beauty",icon:"✨",imageUrl:"https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=900&q=80",sortOrder:4,active:true},
  {id:"grocery",title:"Grocery",slug:"grocery",icon:"🛒",imageUrl:"https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=900&q=80",sortOrder:5,active:true},
  {id:"sports",title:"Sports",slug:"sports",icon:"🏸",imageUrl:"https://images.unsplash.com/photo-1461896836934-ffe607ba8211?auto=format&fit=crop&w=900&q=80",sortOrder:6,active:true},
  {id:"accessories",title:"Accessories",slug:"accessories",icon:"⌚",imageUrl:"https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=900&q=80",sortOrder:7,active:true},
  {id:"kids",title:"Kids",slug:"kids",icon:"🧸",imageUrl:"https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=900&q=80",sortOrder:8,active:true}
];
const shopDefaultProducts = [
  {id:"p-earbuds-pro",sku:"QK-EAR-101",title:"AirSound Pro ANC Earbuds",slug:"airsound-pro-anc-earbuds",categoryId:"electronics",categoryName:"Electronics",brand:"AirSound",price:1799,mrp:3499,stock:48,rating:4.5,ratingCount:128,badge:"Bestseller",featured:true,newArrival:true,active:true,tags:["wireless","audio","anc"],highlights:["Active Noise Cancellation","40h total battery","Dual device pairing"],description:"Premium wireless earbuds with low-latency mode, clear calls and adaptive noise cancellation.",images:["https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-iphone-case",sku:"QK-ACC-102",title:"MagSafe Crystal Armor Case",slug:"magsafe-crystal-armor-case",categoryId:"accessories",categoryName:"Accessories",brand:"Qikly Gear",price:499,mrp:999,stock:120,rating:4.4,ratingCount:82,badge:"Trending",featured:true,active:true,tags:["case","magsafe","iphone"],highlights:["MagSafe compatible","Drop protection","Clear anti-yellow back"],description:"Slim protective case with magnetic alignment and reinforced corners.",images:["https://images.unsplash.com/photo-1601593346740-925612772716?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-sneakers",sku:"QK-FSH-103",title:"StreetFlex Everyday Sneakers",slug:"streetflex-everyday-sneakers",categoryId:"fashion",categoryName:"Fashion",brand:"StreetFlex",price:1299,mrp:2799,stock:76,rating:4.6,ratingCount:214,badge:"Hot Deal",featured:true,newArrival:true,active:true,tags:["shoes","men","casual"],highlights:["Memory foam insole","Breathable mesh","Lightweight sole"],description:"Everyday sneakers designed for long walks, college and casual streetwear.",images:["https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-kurta",sku:"QK-FSH-104",title:"Festive Cotton Silk Kurta Set",slug:"festive-cotton-silk-kurta-set",categoryId:"fashion",categoryName:"Fashion",brand:"Qikly Ethnic",price:999,mrp:2199,stock:54,rating:4.7,ratingCount:146,badge:"Diwali Pick",featured:true,active:true,tags:["kurta","ethnic","festive"],highlights:["Soft cotton-silk blend","Festive embroidery","Comfort fit"],description:"Festive-ready kurta set with a clean silhouette and subtle embroidery.",images:["https://images.unsplash.com/photo-1597983073493-88cd35cf93e9?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-lamp",sku:"QK-HOM-105",title:"GlowCraft Brass Diya Lamp Set",slug:"glowcraft-brass-diya-lamp-set",categoryId:"home",categoryName:"Home & Living",brand:"GlowCraft",price:699,mrp:1499,stock:91,rating:4.8,ratingCount:239,badge:"Festive",featured:true,active:true,tags:["diwali","decor","lamp"],highlights:["Set of 6","Solid brass finish","Gift-ready box"],description:"Traditional brass diya set for festive decor, gifting and pooja corners.",images:["https://images.unsplash.com/photo-1509124110008-4ea7938c8d51?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-watch",sku:"QK-ACC-106",title:"Chrona AMOLED Smart Watch",slug:"chrona-amoled-smart-watch",categoryId:"accessories",categoryName:"Accessories",brand:"Chrona",price:2299,mrp:4999,stock:37,rating:4.3,ratingCount:96,badge:"New",newArrival:true,active:true,tags:["smartwatch","wearable"],highlights:["AMOLED display","7-day battery","Call notifications"],description:"Modern smartwatch with fitness tracking, bright AMOLED display and smart notifications.",images:["https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-facewash",sku:"QK-BEA-107",title:"Glow Daily Vitamin C Face Wash",slug:"glow-daily-vitamin-c-face-wash",categoryId:"beauty",categoryName:"Beauty",brand:"GlowLab",price:349,mrp:599,stock:142,rating:4.5,ratingCount:381,badge:"Top Rated",active:true,tags:["skincare","vitamin-c"],highlights:["Vitamin C","Gentle cleanse","For daily use"],description:"Fresh citrus face wash for everyday cleansing and a bright-looking finish.",images:["https://images.unsplash.com/photo-1556229010-6c3f2c9c2a7a?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-mixer",sku:"QK-HOM-108",title:"HomeChef 750W Mixer Grinder",slug:"homechef-750w-mixer-grinder",categoryId:"home",categoryName:"Home & Living",brand:"HomeChef",price:2199,mrp:3499,stock:26,rating:4.2,ratingCount:74,badge:"Value Deal",active:true,tags:["kitchen","mixer"],highlights:["750W motor","3 stainless jars","2 year warranty"],description:"Powerful kitchen mixer with multiple jars for daily cooking needs.",images:["https://images.unsplash.com/photo-1585659722983-3a675dabf23d?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-football",sku:"QK-SPR-109",title:"ProStrike Football",slug:"prostrike-football",categoryId:"sports",categoryName:"Sports",brand:"ProStrike",price:599,mrp:899,stock:63,rating:4.4,ratingCount:57,badge:"Sports Pick",active:true,tags:["football","outdoor"],highlights:["Machine stitched","All-weather surface","Size 5"],description:"Match-inspired football for practice sessions and weekend games.",images:["https://images.unsplash.com/photo-1553778263-73a83bab9b0c?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-bag",sku:"QK-FSH-110",title:"UrbanPro Laptop Backpack",slug:"urbanpro-laptop-backpack",categoryId:"fashion",categoryName:"Fashion",brand:"UrbanPro",price:899,mrp:1799,stock:88,rating:4.6,ratingCount:191,badge:"Bestseller",active:true,tags:["bag","college","laptop"],highlights:["15.6 inch laptop sleeve","Water-resistant","USB charging port"],description:"Everyday backpack for college, office and short trips with smart organization.",images:["https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-kids-set",sku:"QK-KID-111",title:"MiniMinds Building Blocks 80pc",slug:"miniminds-building-blocks-80pc",categoryId:"kids",categoryName:"Kids",brand:"MiniMinds",price:449,mrp:799,stock:104,rating:4.7,ratingCount:118,badge:"Kids Favourite",active:true,tags:["toys","building"],highlights:["80 colorful blocks","Non-toxic plastic","3+ years"],description:"Creative building set designed for hands-on play and imagination.",images:["https://images.unsplash.com/photo-1599623560574-39d485900c95?auto=format&fit=crop&w=1200&q=85"]},
  {id:"p-grocery",sku:"QK-GRO-112",title:"Premium Dry Fruit Gift Box",slug:"premium-dry-fruit-gift-box",categoryId:"grocery",categoryName:"Grocery",brand:"Qikly Gifts",price:799,mrp:1199,stock:58,rating:4.8,ratingCount:204,badge:"Gift Pick",active:true,tags:["dry-fruits","gifting","diwali"],highlights:["Almonds + cashews","Premium gift box","Festive packaging"],description:"Festive dry-fruit assortment packed for gifting during Diwali and special occasions.",images:["https://images.unsplash.com/photo-1574226516831-e1dff420e37f?auto=format&fit=crop&w=1200&q=85"]}
];
...
async function ensureShopSeeded(){
  ...
  batch.set(meta,{seeded:true,seededAt:FieldValue.serverTimestamp()},{merge:true});
  await batch.commit();
}
...
async function createShopOrder({quote,customer,address,userId,paymentMethod,paymentStatus,razorpayOrderId="",orderStatus="placed",stockReserved=true}){
  const ref=db.collection("shopOrders").doc();const order={id:ref.id,orderNumber:shopOrderNumber(),userId:userId||"",customer:{name:clean(customer?.name,120),email:cleanEmail(customer?.email),phone:clean(customer?.phone,30)},address:{line1:clean(address?.line1,200),line2:clean(address?.line2,200),city:clean(address?.city,80),state:clean(address?.state,80),pincode:clean(address?.pincode,12),landmark:clean(address?.landmark,160)},items:quote.items,subtotal:quote.subtotal,discount:quote.discount,shipping:quote.shipping,total:quote.total,coupon:quote.coupon,paymentMethod,paymentStatus,orderStatus,stockReserved,razorpayOrderId,createdAt:FieldValue.serverTimestamp(),updatedAt:FieldValue.serverTimestamp()};await db.runTransaction(async t=>{await decrementShopStock(t,quote.items,false);t.set(ref,order);});return jsonSafe(order);
}
...
app.post("/api/shop/orders/:id/cancel",guardUser,async(req,res)=>{try{const ref=db.collection("shopOrders").doc(clean(req.params.id,120));await db.runTransaction(async t=>{const snap=await t.get(ref);if(!snap.exists||snap.data().userId!==req.user.id)throw new Error("Order not found.");const o=snap.data();if(!["payment_pending","placed","packed"].includes(o.orderStatus))throw new Error("This order can no longer be cancelled.");if(o.stockReserved)await decrementShopStock(t,o.items||[],true);t.set(ref,{orderStatus:"cancelled",paymentStatus:o.paymentStatus==="paid"?"refund_pending":o.paymentStatus,stockReserved:false,updatedAt:FieldValue.serverTimestamp()},{merge:true});});res.json({ok:true});}catch(e){res.status(400).json({error:e.message});}});
app.get("/api/admin/shop/data",guardAdmin,async(req,res)=>{try{await ensureShopSeeded();const [settings,cats,prods,coupons,orders,users]=await Promise.all([getShopSettings(),getShopCategories(true),getShopProducts(true),getShopCoupons(),listCollection("shopOrders"),listCollection("users")]);const rows=orders.sort((a,b)=>dateMs(b.createdAt)-dateMs(a.createdAt));const stats={products:prods.length,categories:cats.length,orders:rows.length,revenue:rows.filter(x=>x.paymentStatus==="paid"||x.paymentMethod==="cod").filter(x=>x.orderStatus!=="cancelled").reduce((s,x)=>s+money(x.total),0),pending:rows.filter(x=>["payment_pending","placed","packed","shipped","out_for_delivery"].includes(x.orderStatus)).length,customers:users.length};res.json(jsonSafe({settings,categories:cats,products:prods.map(shopPublicProduct),coupons,orders:rows,users:users.map(u=>({id:u.id,name:u.name||"",email:u.email||"",phone:u.phone||"",active:u.active!==false})),stats}));}catch(e){res.status(500).json({error:e.message||"Unable to load shop admin data."});}});
...
app.post("/api/admin/shop/toggle-cod",guardAdmin,async(req,res)=>{try{const enabled=req.body?.enabled===true;await db.collection("shopSettings").doc("main").set({codEnabled:enabled,updatedAt:FieldValue.serverTimestamp()},{merge:true});res.json({ok:true,codEnabled:enabled});}catch(e){res.status(500).json({error:e.message});}});
